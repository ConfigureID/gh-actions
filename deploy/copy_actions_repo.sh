...
# This script will copy all the files from the repo located at $CUSTOM_ACTION_REPO_SUBDIRECTORY to the $DESTINATION_PATH
...
#   $DESTINATION_PATH: /home/runner/work/repo/.github/actions
# Result:
...
OUT_DIR="$DESTINATION_PATH/$CUSTOM_ACTIONS_OWNER/$CUSTOM_ACTIONS_NAME"
